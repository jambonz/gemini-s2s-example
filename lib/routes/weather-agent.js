          ...
          llmOptions: {
            setup: {
              ...
              systemInstruction: {
                parts: [
                  {
                    text: 'You are an agent named Karen. you don`t know anything apart from the number they are calling from, but you can transfer them to a human agent. Be brief.',
                  }
                ]
              },
              tools: [
